...
return packer.startup(function(use)
  ...
  use({ "kylechui/nvim-surround", commit = "c6a1993199237f875f9407eb1c0aa9176117a3ff" })
  ...
  use({ "hrsh7th/cmp-nvim-lsp", commit = "affe808a5c56b71630f17aa7c38e15c59fd648a8" }) -- Extra cmp source from LSP
  use({ "hrsh7th/cmp-nvim-lua", commit = "d276254e7198ab7d00f117e88e223b4bd8c02d21" })
  use { "onsails/lspkind-nvim" } -- Configured in cmp formatting section
  ...
  use({ "hashivim/vim-terraform" }) -- Terraform Config
